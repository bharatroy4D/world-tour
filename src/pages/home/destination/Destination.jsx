...
const Destination = () => {
  ...
  return (
    <div className='bg-blue-50'>
      <div className="container relative pt-10 lg:pt-30 pb-12 px-5 lg:px-10 mx-auto ">
        <h2 className="container text-3xl font-bold text-center text-gray-800 mb-6 roboto ">
          Popular Destinations
        </h2>
        <Slider {...settings}>
          {destinations.map((place) => (
            <Link key={place.id} to={`/viewDetails/${place.id}`}>
        ...
        {/* Search Box */}
        <div className='container hidden lg:block mx-auto px-5 lg:px-20 absolute -top-15 left-1/2 transform -translate-x-1/2 z-20'>
